...
function mostrarResumoAgendamentos(dataStr) {
    ...
    const modalEl = document.getElementById('modalResumoAgendamento');
    const modal = new bootstrap.Modal(modalEl);
    const container = document.getElementById('conteudoResumoDia');

    document.getElementById('modalResumoAgendamentoLabel').textContent = '📊 Resumo de Agendamentos – ' + formatarData(dataStr);
    container.innerHTML = '';
...
// Carrega laboratorios para filtro
...
function aplicarFiltrosURL() {
    ...
    if (laboratorio) {
        document.getElementById("filtroLaboratorio").value = laboratorio;
    }
...
function editarOcupacao(id) {
    ...
    const resumoEl = document.getElementById('modalResumoAgendamento');
